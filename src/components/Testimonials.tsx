...
const reviews = [
  {
    ...
    text: "ELF супроводжували нашу компанію під час складного злиття з іноземним партнером. Команда відпрацювала бездоганно — чітко, швидко, без жодних сюрпризів. Результат перевершив очікування.",
    rating: 5,
  ...
  },
  {
    ...
    text: "Зверталась у справі трудового спору з колишнім роботодавцем. Навіть не вірила, що можна виграти — але юристи ELF довели протилежне. Дуже вдячна за підтримку та професіоналізм.",
    rating: 5,
    tag: "Судові спори",
  },
  {
  ...
  },
  {
    ...
    role: "ФОП, IT-сфера",
    text: "Шукала юриста для оформлення договорів з іноземними клієнтами. ELF зробили все швидко та якісно, ще й попередили про можливі ризики, про які я навіть не думала. Рекомендую!",
    rating: 5,
    tag: "Корпоративне право",
  },
];
