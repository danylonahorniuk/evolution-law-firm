      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 grid lg:grid-cols-2 gap-20 items-center">
        <div className="relative">
          ...
          <div className="absolute -bottom-8 -left-8 bg-[var(--cream-warm)] p-8 shadow-lg">
            ...
            <div className="text-[11px] uppercase tracking-wider text-[var(--ink-mid)] mt-1">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-6">
            {[
              ...
              <div
                key={s.label}
                className="p-5 border border-[var(--border)] hover:border-[var(--gold)] transition-colors group"
              >
