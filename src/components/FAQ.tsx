...
const faqs = [
  {
    ...
    a: "Перша консультація в Meridian Law є безкоштовною. Ми вислухаємо вашу ситуацію, дамо попередню оцінку і запропонуємо варіанти подальшої роботи з чіткими цінами — без прихованих платежів.",
  },
  {
